    ...
    for node in graph.nodes:
        ...
        raw_nodes.append({
            "data": {
                ...
                "sqlContent": nd.get("sql_content"),
                "filePath": nd.get("file_path"),
                "sourceUri": nd.get("source_uri"),
                "contentHash": nd.get("content_hash"),
                "sourceType": nd.get("source_type"),
                "expressionType": nd.get("expression_type"),
                "expression": nd.get("expression"),
                "op": nd.get("op"),
                "fingerprint": nd.get("fingerprint"),
                "outputName": nd.get("output_name"),
                "tableId": nd.get("table_id"),
                "fullName": label,
                "degree": 0,
            }
        })
